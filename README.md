...
- [max_connections](https://postgrespro.ru/docs/postgresql/16/runtime-config-connection#GUC-MAX-CONNECTIONS) = 100
- [max_prepared_transactions](https://postgrespro.ru/docs/postgresql/16/runtime-config-resource#GUC-MAX-PREPARED-TRANSACTIONS) = 100
- [shared_buffers](https://postgrespro.ru/docs/postgresql/16/runtime-config-resource#GUC-SHARED-BUFFERS) = 2GB
- [temp_buffers](https://postgrespro.ru/docs/postgresql/16/runtime-config-resource#GUC-TEMP-BUFFERS) = 1MB
- [work_mem](https://postgrespro.ru/docs/postgresql/16/runtime-config-resource#GUC-WORK-MEM) = 1MB
...
```
 tablespace |                    objects                     |   datname    
------------+------------------------------------------------+--------------
 pg_default | _pg_foreign_data_wrappers                     +| fakeblackmom
            | _pg_foreign_servers                           +| 
            ...
            | view_table_usage                              +| 
            | views                                          | 
 pg_default | _pg_foreign_data_wrappers                     +| postgres
            | _pg_foreign_servers                           +| 
            | _pg_foreign_table_columns                     +| 
            | _pg_foreign_tables                            +| 
            | _pg_user_mappings                             +| 
            ...
            | view_table_usage                              +| 
            | views                                          | 
 pg_default | _pg_foreign_data_wrappers                     +| template0
            | _pg_foreign_servers                           +| 
            | _pg_foreign_table_columns                     +| 
            | _pg_foreign_tables                            +| 
            | _pg_user_mappings                             +| 
            ...
            | view_table_usage                              +| 
            | views                                          | 
 pg_default | _pg_foreign_data_wrappers                     +| template1
            | _pg_foreign_servers                           +| 
            | _pg_foreign_table_columns                     +| 
            | _pg_foreign_tables                            +| 
            | _pg_user_mappings                             +| 
 ...
 pg_global  | pg_auth_members                               +| 
            ...
            | pg_toast_6243                                 +| 
            | pg_toast_6243_index                            | 
 qva60      | temp_book_loans_pkey                           | 
 swm74      | temp_book_loans                               +| 
            | temp_book_statistics                           | 
(7 строк)
```